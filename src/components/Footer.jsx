        ...
        <>
            <footer id="footer">
                <div className="box first">
                    <img src="/img/footer/logo.svg" alt="" className='logo' />
                    ...
                    <div className="icons">
                        <img src="/img/footer/fb.svg" alt="" className="icon" />
                        <img src="/img/footer/twitter.svg" alt="" className="icon" />
                        <img src="/img/footer/linkedin.svg" alt="" className="icon" />
                        <img src="/img/footer/instra.svg" alt="" className="icon" />
                    </div>
                </div>
